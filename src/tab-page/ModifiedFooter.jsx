    ...
    <div style="width: 100%; padding: 40px 24px !important;">
      <div style="max-width: 1336px; margin: 0 auto;">
        <div class="footer-elements">
            ...
            <div>
                <ul>
                    <li><a href="https://pupilica.com/about-us">Hakkımızda</a></li>
                    <li><a href="https://pupilica.com/educations">Eğitimler</a></li>
                    <li><a href="https://pupilica.com/instructors">Eğitmenler</a></li>
                </ul>
            </div>
            <div>
                <ul>
